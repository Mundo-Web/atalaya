                  ...
                  <tbody>
                    {
                      projectsRemaining.map(({ id, client, type, remaining_amount, cost, ends_at }) => {
                        return (<tr key={`remaining-project-${id}`}>
                          ...
                          <td className='text-end'><div style={{width: 'max-content'}}>S/. {Number2Currency(cost)}</div></td>
                          <td className='text-end'><div style={{width: 'max-content'}}>S/. {Number2Currency(remaining_amount)}</div></td>
                        </tr>)
                      })
                    }
                  </tbody>
